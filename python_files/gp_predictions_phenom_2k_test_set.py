...
N_test = 2000
npz_path = f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/Phenom_Uniform_n{N_test}_r2000_f5/library2_gp_nn_accuracy/gp_predictions_for_{N_test}_test_points.npz'
hdf5_file_path = f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/Phenom_Uniform_n{N_test}_r2000_f5/library2_gp_nn_accuracy/sam-library.hdf5'

gp_dir = Path(f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/Phenom_Uniform_n{N_test}_r2000_f5/gp_training_output')
##############
