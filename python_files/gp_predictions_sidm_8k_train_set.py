...
N_train = 8000 
npz_path = f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/SIDM_Astro_Uniform_Extended_Version2_n{N_train}_r2000_f5/library/gp_predictions_for_{N_train}_train_points.npz'
hdf5_file_path = f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/SIDM_Astro_Uniform_Extended_Version2_n{N_train}_r2000_f5/library/sam-library.hdf5'
gp_dir = Path(f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/SIDM_Astro_Uniform_Extended_Version2_n{N_train}_r2000_f5/gp_training_output')
###########
