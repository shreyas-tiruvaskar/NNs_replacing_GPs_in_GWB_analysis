...
# for GPs
# chain_path = Path(f'{PROJECT_ROOT}/holodeck_output_lib_gp_mcmc/{PARAM_SPACE}_n{NSAMPLES}_r{NREALS}_f{NFREQS}/gp_mcmc_log_likelihood_all_freqs/ceffyl_output_hd_mp_dp_curn/chain_1.txt')
