...
ceffyldir = f'{PROJECT_ROOT}/sti50/Data/ceffyl_data/30f_fs{hd+mp+dp+cp}_ceffyl_hd-only'
# outdir = str(Path(OUTPUT).parent / 'log_likelihood_all_freqs/ceffyl_output_hd_mp_dp_curn')
outdir = str(
    Path(OUTPUT).parent
    / 'gp_log_likelihood_all_freqs'
