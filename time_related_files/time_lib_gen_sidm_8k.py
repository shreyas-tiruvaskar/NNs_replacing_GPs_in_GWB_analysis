...
cmd = [
    ...
    "--no-ss",
    "--no-params",
    "PS_Classic_SIDM_Astro_Extended_Version2",
    "/home/sti50/neural_network/notebooks_and_files_for_final_results/time_related_files/SIDM_Astro_Extended_Version2_n8000_r2000_f5/library/" # or wherever you want to save it
]
