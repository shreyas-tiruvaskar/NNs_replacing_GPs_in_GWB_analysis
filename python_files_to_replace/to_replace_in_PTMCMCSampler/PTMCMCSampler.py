...
Nfreqs = int(5) # added by Shreyas (11.11.2025)
...
class PTSampler(object):
    ...
    def __init__(
        ...
        ndim,
        logl,
        logl_all_freqs, # added by Shreyas (11.11.2025)
        logp,
        cov,
        groups=None,
        loglargs=[],
        ...
        logpargs=[],
        logpkwargs={},
        loglargs_all_freqs=[], # added by Shreyas (11.11.2025)
        loglkwargs_all_freqs={}, # added by Shreyas (11.11.2025)
        logl_grad=None,
        logp_grad=None,
        comm=MPI.COMM_WORLD,
        outDir="./chains",
        ...
        self.logl_all_freqs = _function_wrapper(logl_all_freqs, loglargs_all_freqs, loglkwargs_all_freqs)  # added by Shreyas (11.11.2025)
    ...
    def initialize(
        ...
        self._lnlike_all_freqs = np.zeros((N, Nfreqs))  # added by Shreyas (11.11.2025)
    ...
    def updateChains(self, p0, lnlike0, lnlike0_all_freqs, lnprob0, iter): # modified by Shreyas (11.11.2025)
        """
        ...
        if iter % self.thin == 0:
            ...
            self._lnlike_all_freqs[ind, :] = lnlike0_all_freqs  # added by Shreyas (11.11.2025)
    ...
    def sample(
        ...
        if self.resume and self.resumeLength > 0:
            ...
            p0, lnlike0_all_freqs, lnlike0, lnprob0 = self.resumechain[0, :-4 - Nfreqs], self.resumechain[0, -4 - Nfreqs: -4] , self.resumechain[0, -3], self.resumechain[0, -4] # added by Shreyas (11.11.2025)
            ...
            if lp == float(-np.inf):
                ...
                lnprob0 = -np.inf
                lnlike0 = -np.inf
                lnlike0_all_freqs = np.full(Nfreqs, -np.inf)  # added by Shreyas (11.11.2025)

            else:

                lnlike0 = self.logl(p0)
                lnlike0_all_freqs = self.logl_all_freqs(p0)  # added by Shreyas (11.11.2025)
                lnprob0 = 1 / self.temp * lnlike0 + lp

        # record first values
        # self.updateChains(p0, lnlike0, lnprob0, i0)
        self.updateChains(p0, lnlike0, lnlike0_all_freqs, lnprob0, i0) # modified by Shreyas (11.11.2025)
        ...
        while runComplete is False:
            ...
            p0, lnlike0, lnlike0_all_freqs, lnprob0 = self.PTMCMCOneStep(p0, lnlike0, lnlike0_all_freqs, lnprob0, iter) # modified by Shreyas (11.11.2025)
    ...
    def PTMCMCOneStep(self, p0, lnlike0, lnlike0_all_freqs, lnprob0, iter): # modified by Shreyas (11.11.2025)
        """
        Function to carry out PTMCMC sampling.
        ...
        if self.resume and self.resumeLength > 0 and iter < self.resumeLength:
            ...
            p0, lnlike0_all_freqs, lnlike0, lnprob0 = self.resumechain[iter, :-4 - Nfreqs], self.resumechain[iter, -4 - Nfreqs: -4] , self.resumechain[iter, -3], self.resumechain[iter, -4] # added by Shreyas (11.11.2025)
            ...
            if lp == -np.inf:
                ...
                newlnlike_all_freqs = self.logl_all_freqs(y)  # added by Shreyas (11.11.2025)
            ...
            if diff > np.log(self.stream.random()):
                ...
                p0, lnlike0, lnlike0_all_freqs, lnprob0 = y, newlnlike, newlnlike_all_freqs, newlnprob # modified by Shreyas (11.11.2025)
        ...
        if iter % self.Tskip == 0 and self.nchain > 1:
            ...
            p0, lnlike0, lnlike0_all_freqs, lnprob0 = self.PTswap(p0, lnlike0, lnlike0_all_freqs, lnprob0, iter) # modified by Shreyas (11.11.2025)

        # self.updateChains(p0, lnlike0, lnprob0, iter)
        self.updateChains(p0, lnlike0, lnlike0_all_freqs, lnprob0, iter) # modified by Shreyas (11.11.2025)

        # return p0, lnlike0, lnprob0
        return p0, lnlike0, lnlike0_all_freqs, lnprob0 # modified by Shreyas (11.11.2025)

    # def PTswap(self, p0, lnlike0, lnprob0, iter):
    def PTswap(self, p0, lnlike0, lnlike0_all_freqs, lnprob0, iter): # modified by Shreyas (11.11.2025)
        """
        ...
        log_Ls_all_freqs = self.comm.gather(lnlike0_all_freqs, root=0)  # added by Shreyas (11.11.2025)
        ...
        if self.MPIrank == 0:
            ...
            for j in range(self.nchain):
                ...
                log_Ls_all_freqs[j] = log_Ls_all_freqs[swap_map[j]]  # added by Shreyas (11.11.2025)

        # broadcast the new samples and log_Ls to all chains
        p0 = self.comm.scatter(p0s, root=0)
        lnlike0 = self.comm.scatter(log_Ls, root=0)
        lnlike0_all_freqs = self.comm.scatter(log_Ls_all_freqs, root=0)  # added by Shreyas (11.11.2025)
    ...
    def _writeToFile(self, iter):
        ...
        for jj in range((iter - self.isave), iter, self.thin):
            ...
            self._chainfile.write("\t" + "\t".join("%f" % self._lnlike_all_freqs[ind, jj] for jj in range(Nfreqs))) # added by Shreyas (11.11.2025)
